...
% RootParameterNames = fieldnames(get_param(fname,'ObjectParameters'));
% 
% ModelParameterNames = fieldnames(get_param(fname, 'ObjectParameters'))
% GlobalParameterNames = setdiff(RootParameterNames,ModelParameterNames)

% 获取全局参数的值。
% GlobalParameterValue = get_param(0,'CurrentSystem');  % auto_created_model
