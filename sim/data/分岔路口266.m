%定义一条分岔路口和两辆车，直线路段为双车道，长度为145m,车辆v1的初始位置为x=10,y=2,z=0,车辆v2的初始位置为x=15,y=-3;z=0
...
% 添加直线道路段
road(scenario, [0 0 0; 145 0 0], 'lanes', lanespec(2));
...
% 调整车辆的初始位置
v1.Position = [10 2 0];%车辆v1的初始位置为x=10,y=,2z=0
